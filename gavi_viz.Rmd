...
line_plot_acres_rangetotal <- ggplot() +
  ...
  labs(color = "Land Class",
       y = "Acres",
       x = "",
       title = "Observed and Projected Acres by Land Class") +
  scale_y_continuous(labels = scales::comma) +
  scale_x_continuous(breaks = c(2012, 2016, 2019, 2030), labels = c("'12", "'16", "'19", "'30"))
...
line_plot_stock_ag <- ggplot() +
  ...
  labs(color = "Land Class",
       y = "MTCO2e",
       x = "",
        title = "Observed and Projected Carbon Stocks by Land Class") +
  scale_y_continuous(labels = scales::comma) +
  scale_x_continuous(breaks = c(2012, 2016, 2019, 2030), labels = c("'12", "'16", "'19", "'30"))
...
line_plot_n2o <- ggplot() +
  ...
  labs(color = "Land Class",
       y = "MTCO2e",
       x = "",
       title = "Observed and Projected Nitrous Oxide Emissions by Land Class") +
  scale_y_continuous(labels = scales::comma) +
  scale_x_continuous(breaks = c(2012, 2016, 2019, 2030), labels = c("'12", "'16", "'19", "'30"))
...
line_plot_acres_rangetotal
ggsave(here("files", "figs", "line_plot_acres_rangetotal.png"))

line_plot_acres_ag
ggsave(here("files", "figs", "line_plot_acres_ag.png"))

line_plot_n2o
ggsave(here("files", "figs", "line_plot_n2o.png"))

line_plot_stock_ag
ggsave(here("files", "figs", "line_plot_stock_ag.png"))

line_plot_stock_rangetotal
ggsave(here("files", "figs", "line_plot_stock_rangetotal.png"))
