...
writeRaster(rast_landclass_fact, "landclass_raster.tif")
writeRaster(rast_totalstock, "carbonstock_raster.tif")
writeRaster(rast_abvgc, "aboveground_raster.tif")
writeRaster(rast_soilc, "soil_raster.tif")
writeRaster(rast_n2o, "n2o_raster.tif")
